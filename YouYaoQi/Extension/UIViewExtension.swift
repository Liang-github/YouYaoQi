...
extension UIView {
    ...
    class BlurView {
        ...
        private func applyBlurEffect(style: UIBlurEffectStyle, blurAlpha: CGFloat) {
    ...
    private func addAlignConstraintToSuperview(attribute: NSLayoutAttribute) {
        superview?.addConstraint(
            NSLayoutConstraint(item: self, attribute: attribute, relatedBy: NSLayoutRelation.equal, toItem: superview, attribute: attribute, multiplier: 1, constant: 0
            )
        )
    }
